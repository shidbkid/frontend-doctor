...
export default function VideoPage() {
  ...
  // Return the layout with the "Video not found" message if videoId or selectedVideo is invalid
  ...
  // Render the main content when videoId and selectedVideo are valid
  return (
    <Layout>
